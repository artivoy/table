...
export type EpisodesQuery = { __typename?: 'Query', Page?: { __typename?: 'Page', media?: Array<{ __typename?: 'Media', type?: MediaType | null, popularity?: number | null, averageScore?: number | null, status?: MediaStatus | null, title?: { __typename?: 'MediaTitle', english?: string | null, native?: string | null } | null } | null> | null, pageInfo?: { __typename?: 'PageInfo', currentPage?: number | null, hasNextPage?: boolean | null, lastPage?: number | null, perPage?: number | null, total?: number | null } | null } | null };

export const EpisodesDocument = gql`
    query Episodes($page: Int, $perPage: Int, $sort: [MediaSort], $search: String) {
  ...
  export class EpisodesGQL extends Apollo.Query<EpisodesQuery, EpisodesQueryVariables> {
    override document = EpisodesDocument;
